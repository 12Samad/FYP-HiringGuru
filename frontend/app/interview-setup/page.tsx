...
export default function InterviewSetup() {
  ...
  const getEmotionFeedback = () => {
    if (!detectedEmotion) {
      return (
        <p className="text-white">Current emotion: <span className="font-bold text-yellow-400">Analyzing...</span></p>
      );
    }
    ...
    return (
      <p className="text-white">
        Current emotion: <span className={`font-bold ${colorClass}`}>{emotionCapitalized} {emoji}</span>
      </p>
    );
  };
  ...
  const renderCountdown = () => {
    return (
      <div className="flex flex-col items-center justify-center h-64">
        ...
        <p className="text-xl text-gray-400">Starting in {countdown} second{countdown !== 1 ? 's' : ''}...</p>
      </div>
    );
  };
            ...
            <div className="flex flex-col lg:flex-row gap-6">
              ...
              <div className="lg:w-1/2 space-y-4">
                <div className="bg-[#1A1A1A] p-6 rounded-lg text-white">
                  ...
                  <div className="mt-4 p-3 bg-[#222222] rounded-lg">
                    {getEmotionFeedback()}
                  </div>
                </div>
              </div>
